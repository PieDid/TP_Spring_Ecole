...
<body>
	...
	<div align="center">
		...
		<form:form modelAttribute="aideUpdateCommand" method="POST"
			action="${pageContext.request.contextPath}/aideUpdate-meth">
			...
			<table cellspacing="5px">
				...
				<tr>
					<td><form:label class="flabel" path="page">Page : </form:label>
					</td>
					<td><form:input class="finput" path="page" /></td>
					<td><form:errors class="ferror" path="page" /></td>
				</tr>

				<tr>
					<td><form:label class="flabel" path="contenu">Contenu : </form:label>
					</td>
					<td><form:input class="finput" path="contenu" /></td>
