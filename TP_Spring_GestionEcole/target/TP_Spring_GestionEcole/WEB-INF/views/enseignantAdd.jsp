...
<title>Page d'ajout d'un enseignant</title>
...
<body>
	...
	<div align="center">
		...
		<form:form modelAttribute="ensAddCommand" method="POST"
			action="${pageContext.request.contextPath}/ensAdd-meth">
			...
			<table>
				<tr>
					...
					<td><form:input class="finput" path="nom"
							placeholder="Dumbledore" /></td>
				...
				<tr>
					...
					<td><form:input class="finput" path="prenom"
							placeholder="Albus Percival Wulfric Brian" /></td>
				...
				<tr>
					...
					<td><form:input class="finput" path="email"
							placeholder="albus.dumbledore@poudlard.uk" /></td>
				...
				<tr>
					...
					<td><form:input class="finput" path="motDePasse"
							placeholder="Veuillez entrer votre mot de passe" /></td>
