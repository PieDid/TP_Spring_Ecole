...
<title>Page de modification d'un Administrateur</title>
...
<body>
	...
	<div align="center">
		<h1>Modification des informations d'un Administrateur</h1>
	</div>

	<div align="center">

		<form:form modelAttribute="adminUpdateCommand" method="POST"
			action="${pageContext.request.contextPath}/adminUpdate-meth">
