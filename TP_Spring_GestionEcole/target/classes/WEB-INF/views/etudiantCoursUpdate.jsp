...
<title>Page de modification de la relation Etudiant-Cours</title>
</head>
<body>
	...
	<div align="center">
		<h2>Modification d'une relation Etudiant-Cours</h2>
	</div>

	<div align="center">

		<form:form modelAttribute="etudiantCoursUpdateCommand" method="POST"
			action="${pageContext.request.contextPath}/etudiantCoursUpdate-meth">
