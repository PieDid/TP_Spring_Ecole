...
<spring:url value="/assets/images/universite_photo_bis.jpg"
	var="photo_fac" />
...
<body>
	...
	<div align="center">
		...
		<c:if test="${not empty param.logout_message}">
			<font class="deconnexion"> Déconnecté avec succès </font>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col">
					<a href="${pageContext.request.contextPath}/ensList">Liste des
						enseignants</a>
				</div>
			...
			<div class="row">
				...
				<div class="col">
					<a href="${pageContext.request.contextPath}/etuList">Liste des
						étudiants</a>
				</div>
				<div class="col">
			...
			<div class="row">
				...
				<div class="col">
					<a href="${pageContext.request.contextPath}/etudiantCoursList">Liste
						des absences</a>
				</div>
				<div class="col">
