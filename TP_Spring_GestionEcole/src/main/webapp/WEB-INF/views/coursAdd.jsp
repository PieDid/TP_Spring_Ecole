		...
		<form:errors path="*" cssClass="error_validation" element="div" />
			...
			<table cellspacing="5px">
				...
				<tr>
					...
					<td> <form:input class="finput" path="matiere.libelle" placeholder="Entrez le libellé de la matière"/> </td> <!-- chercher pour avoir la liste des matiere -->
				...
				<tr>
					...
					<td> <form:input class="finput" path="promotion.libelle" placeholder="Entrez l'année" pattern="[0-9]{4}"/> </td> <!-- chercher pour avoir la liste des promotions -->
